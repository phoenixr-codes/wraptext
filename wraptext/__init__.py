...
class TextWrapper:
    ...
    def _wrap_chunks(self, chunks):
        ...
        if self.max_lines is not None:
            ...
            if (
                _display_len(indent) + _display_len(self.placeholder.lstrip())
                > self.width
            ):
        ...
        while chunks:
            ...
            width = self.width - _display_len(indent)
            ...
            if chunks and _display_len(chunks[-1]) > width:
                self._handle_long_word(chunks, cur_line, cur_len, width)
                cur_len = sum(map(len, cur_line))

            # If the last chunk on this line is all whitespace, drop it.
            if self.drop_whitespace and cur_line and cur_line[-1].strip() == "":
                cur_len -= _display_len(cur_line[-1])
                del cur_line[-1]
            ...
            if cur_line:
                if (
                    ...
                    while cur_line:
                        if (
                            cur_line[-1].strip()
                            and cur_len + _display_len(self.placeholder) <= width
                        ):
                        ...
                        if lines:
                            ...
                            if (
                                _display_len(prev_line) + _display_len(self.placeholder)
                                <= self.width
                            ):
